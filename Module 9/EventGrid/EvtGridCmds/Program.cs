...
class Program
{
    static string topicHost = "ps-namespace.westeurope-1.eventgrid.azure.net";
    static string topicEP = $"https://{topicHost}/api/events";
    static string topicKey = "KiMHhXDLdLVc46bzFpIsqiEHoCBaHWpoZclfatroz0S9Hg4F0NVeJQQJ99CDAC5RqLJXJ3w3AAABAZEGLPhx";
