...
class Program
{
    private static string conStr = "Endpoint=sb://ps-hubben.servicebus.windows.net/;SharedAccessKeyName=fiat;SharedAccessKey=KVncyXym9cG6dMDc0+tAZRfvKGPwUbdqC+AEhMHt03I=;EntityPath=hupholland";
