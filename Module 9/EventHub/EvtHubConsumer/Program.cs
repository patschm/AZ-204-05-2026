...
class Program
{
    private const string conStr = "Endpoint=sb://ps-hubben.servicebus.windows.net/;SharedAccessKeyName=lezer;SharedAccessKey=jTk3eJv2SIS4fhCFYd7DH2OC57cyFNpZa+AEhB9tSlA=;EntityPath=hupholland";
    private const string hubName = "hupholland";

    private const string checkpointStorage = "DefaultEndpointsProtocol=https;AccountName=psoffsetter;AccountKey=A2vAXHzXqKCAMEv/euEduWa48uqJOJk5No4UgiwFsrOndFokCwzocmqVQhEruNjid/YZ0PeFyv91+AStEB62Xg==;EndpointSuffix=core.windows.net";
    ...
    private static async Task UsingProcessors(string naam)
    {
        ...
        BlobContainerClient blobContainerClient = new BlobContainerClient(checkpointStorage, "zeurbus");
