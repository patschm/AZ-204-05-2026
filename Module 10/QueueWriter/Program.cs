...
class Program
{
    ...
    static string EndPoint = "sb://ps-platform.servicebus.windows.net";
    static (string Name, string Key) SasKeyManager = ("RootManageSharedAccessKey","");
    static (string Name, string Key)  SasKeyWriter = ("schhrijver", "3RFRNzZsOe4sNRz1O1U9XEOfjP7Oaw8f5+ASbGPXzE8=");
    static string QueueName = "kueueue";
