...
class Program
{
    static string EndPoint = "ps-platform.servicebus.windows.net";
    static (string Name, string Key) SasKeyManager = ("RootManageSharedAccessKey", "VNJjNglsPKGnIxa0XUivX+AaB0bOSI1Pe+ASbMss71M=");
    static (string Name, string Key) SasKeyWriter = ("schrijvert", "EfERarfjpu0ECKqnz/oJq9KWyCSWNm/3S+ASbHEtyDk=");
