...
internal class CosmosDb
{
    ...
    private string _sqlServerSource = @"Server=.\SQLEXPRESS;Database=ProductCatalog;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=true;";
    ...
    private async Task CreateDatabaseAsync()
    {
        ...
        await _cosmosClient.CreateDatabaseIfNotExistsAsync(Database, throughput: 8000);
    }
