...
internal class Program
{
    ...
    private static string PrimaryKey = "FVXNdoEFqtdk2yExw3Wns2PFpP0aoByEvmirrWw2zRhXFX58cGCp5IzuzHoq2UO32BeDknKO6nYRACDbcUFrfQ==";
    private static string Database = "ProductCatalog";
    ...
    private static async Task QueryDocumentsAsync()
    {
        ...
        var query = "SELECT * FROM pWHERE p.Type = 'product'";
    ...
    private static async Task UpsertDocumentAsync()
    {
        ...
        Console.WriteLine($"Product Upsert costs {response.RequestCharge} RUs");
