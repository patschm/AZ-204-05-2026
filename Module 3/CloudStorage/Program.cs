...
class Program
{
    private const string connectionString = "DefaultEndpointsProtocol=https;AccountName=psstoor;AccountKey=UoF+6Of/h4JRM3bb9S0brHA/ACHEqsivEwmDsHy1Mw4Qr7EVxHtwXLkQnELuFRfbBgVIC6cfnXT7+AStkqtiXA==;EndpointSuffix=core.windows.net";
    ...
    private static void WriteSimple()
    {
        ...
        BlobClient blob = container.GetBlobClient("blaat\\castle0.jpg");
    ...
    private static void ReadSimple()
    {
        ...
        using (FileStream fs = File.OpenWrite(basePath + "chambord11.jpg"))
        {
    ...
    private static async Task MiscAsync()
    {
        ...
        BlobClient blob = container.GetBlobClient("castle100.jpg");
        using (FileStream fs = File.OpenRead(basePath + "chambord.jpg"))
        {
            blob.Upload(fs, true);
        }
